...
<h2>리소스를 찾을 수 없음 (VFS)</h2>
<p>요청한 파일이 캐시에 없습니다: <code>${a.pathname}</code></p>
<p>SillyTavern 페이지로 돌아가 이 캐릭터의 WebZip을 다시 가져오거나 허용해 주세요. 또는 진입 페이지의 리소스 경로가 올바른지 확인하세요 (상대 경로 사용 권장).</p>`,{status:404,headers:{"Content-Type":"text/html; charset=utf-8"}}):new Response("Not Found",{status:404,headers:{"Content-Type":"text/plain; charset=utf-8"}})})())});
